;;; reference-explorer-source-lookup.el --- UI backed by Lookup for Emacs -*- lexical-binding: t -*-
...
(defcustom reference-explorer-source-lookup-query-function
...
(defcustom reference-explorer-source-lookup-origin-position-function
...
(defcustom reference-explorer-source-lookup-word-candidates-function
  #'reference-explorer-query-segment-word-candidates-at-point
  "Function returning contextual query candidates around point."
  :type 'function
  :group 'reference-explorer-source-lookup)

(defcustom reference-explorer-source-lookup-word-bound-candidates-function
  #'reference-explorer-query-segment-word-bound-candidates-at-point
  "Function returning contextual query bounds around point."
  :type 'function
  :group 'reference-explorer-source-lookup)

(defcustom reference-explorer-source-lookup-display-buffer-function #'display-buffer
  "Function used to display a committed dictionary entry buffer."
  :type 'function
  :group 'reference-explorer-source-lookup)

(defcustom reference-explorer-source-lookup-converted-completion-style nil
...
(defcustom reference-explorer-source-lookup-query-conversion-function
  #'reference-explorer-source-lookup--roman-to-hiragana
...
(defun reference-explorer-source-lookup-query-at-point ()
  "Return the configured reference query at point."
  (funcall reference-explorer-source-lookup-query-function))

(defun reference-explorer-source-lookup-origin-position-at-point ()
  "Return the visible origin position used to anchor reference UI."
  (funcall reference-explorer-source-lookup-origin-position-function))

(defun reference-explorer-source-lookup-word-candidates-at-point ()
  "Return contextual query candidates around point."
  (funcall reference-explorer-source-lookup-word-candidates-function))

(defun reference-explorer-source-lookup-word-bound-candidates-at-point ()
  "Return contextual query bounds around point."
  (funcall reference-explorer-source-lookup-word-bound-candidates-function))

(defun reference-explorer-source-lookup--set-provider-order (symbol value)
  "Set customization SYMBOL to VALUE and update Reference Explorer rules."
  (set-default symbol value)
  (setq reference-explorer-provider-rules `((t . ,value))))

(defcustom reference-explorer-source-lookup-provider-order
...
commands and actions."
  :type '(repeat symbol)
  :set #'reference-explorer-source-lookup--set-provider-order
  :group 'reference-explorer-source-lookup)

(setq reference-explorer-query-function
      #'reference-explorer-source-lookup-query-at-point
      reference-explorer-origin-position-function
      #'reference-explorer-source-lookup-origin-position-at-point
      reference-explorer-provider-rules
      `((t . ,reference-explorer-source-lookup-provider-order)))

(defcustom reference-explorer-source-lookup-content-font-family nil
...
(defcustom reference-explorer-source-lookup-consult-mode 'literal
  "Search mode used by the next blank Lookup invocation.
`literal' searches the input as written.  `converted' transforms it with
`reference-explorer-source-lookup-query-conversion-function' and filters headings with
`reference-explorer-source-lookup-converted-completion-style'.  The value is saved by
...
(when (eq reference-explorer-source-lookup-consult-mode 'reading)
  (setq reference-explorer-source-lookup-consult-mode 'converted))

(defcustom reference-explorer-source-lookup-search-debounce 0.15
  "Seconds to debounce dynamic Lookup entry searches."
  :type 'number
  :group 'reference-explorer-source-lookup)

(defcustom reference-explorer-source-lookup-quick-max-candidates 8
  "Maximum number of candidates shown by quick Lookup."
  :type 'integer
  :group 'reference-explorer-source-lookup)

(defcustom reference-explorer-source-lookup-quick-max-width 60
...
(defcustom reference-explorer-source-lookup-preview-debounce 0.25
  "Seconds to wait before previewing the selected Lookup entry."
  :type 'number
  :group 'reference-explorer-source-lookup)

(defcustom reference-explorer-source-lookup-preview-max-width 80
  "Maximum width in columns of the temporary Lookup preview."
  :type 'integer
  :group 'reference-explorer-source-lookup)

(defcustom reference-explorer-source-lookup-preview-min-width 20
...
(defcustom reference-explorer-source-lookup-docset-preview-max-width 100
  "Maximum width in columns of a temporary docset article preview."
  :type 'integer
  :group 'reference-explorer-source-lookup)

(defcustom reference-explorer-source-lookup-docset-preview-min-width 64
...
(defcustom reference-explorer-source-lookup-docset-preview-max-height 28
  "Maximum height in lines of a temporary docset article preview."
  :type 'integer
  :group 'reference-explorer-source-lookup)

(defcustom reference-explorer-source-lookup-docset-preview-renderer 'webkit
...
(defcustom reference-explorer-source-lookup-docset-webkit-font-size 14
...
(defcustom reference-explorer-source-lookup-docset-webkit-preview-width 760
  "Preferred width in pixels of a temporary WebKit docset preview."
  :type 'integer
  :group 'reference-explorer-source-lookup)

(defcustom reference-explorer-source-lookup-docset-webkit-preview-min-width 480
  "Minimum usable width in pixels of a WebKit docset preview."
  :type 'integer
  :group 'reference-explorer-source-lookup)

(defcustom reference-explorer-source-lookup-docset-webkit-preview-height 520
...
(defcustom reference-explorer-source-lookup-preview-font-height 0.9
  "Font height of temporary Lookup previews relative to the default face."
  :type 'number
  :group 'reference-explorer-source-lookup)

(defcustom reference-explorer-source-lookup-preview-width-slack 2
  "Extra character widths reserved beyond measured preview text."
  :type 'integer
  :group 'reference-explorer-source-lookup)

(defcustom reference-explorer-source-lookup-quick-left-margin-width 0.5
  "Width of the quick candidate list's left margin, in columns."
  :type 'number
  :group 'reference-explorer-source-lookup)

(defcustom reference-explorer-source-lookup-quick-right-margin-width 0.5
  "Width of the quick candidate list's right margin, in columns."
  :type 'number
  :group 'reference-explorer-source-lookup)

(defcustom reference-explorer-source-lookup-preview-margin-width 1
...
(defconst reference-explorer-source-lookup-docset-content-buffer-name "*Docset Reference*"
  "Buffer used for committed docset content.")

(defconst reference-explorer-source-lookup-preview-buffer-name " *Lookup Preview*"
  "Base name for hidden buffers used by temporary Lookup previews.")

(defconst reference-explorer-source-lookup--preview-horizontal-overhead 2
  "Child-frame pixels outside the preview's horizontal body.")

(defconst reference-explorer-source-lookup--preview-vertical-overhead 2
  "Child-frame pixels outside the preview's measured vertical body.")

(defconst reference-explorer-source-lookup--preview-border-width 1
  "Internal border width of a temporary preview frame in pixels.")

(cl-defstruct (reference-explorer-source-lookup--preview
               (:constructor reference-explorer-source-lookup--make-preview
...
(cl-defstruct (reference-explorer-source-lookup--quick-session
               (:constructor reference-explorer-source-lookup--make-quick-session))
...
(cl-defstruct (reference-explorer-source-lookup--thesaurus-candidate
               (:constructor reference-explorer-source-lookup--make-thesaurus-candidate))
...
(defvar reference-explorer-source-lookup-history nil
...
(defvar reference-explorer-source-lookup--roman-rules nil
  "Normalized copy of Emacs's standard Roman-to-kana rules.")

(defvar reference-explorer-source-lookup--consult-toggle-tag nil)
(defvar reference-explorer-source-lookup--active-consult-mode nil)
(defvar reference-explorer-source-lookup--consult-origin nil)
(defvar reference-explorer-source-lookup--consult-query-options nil)
(defvar reference-explorer-source-lookup--consult-query-index nil)
(defvar reference-explorer-source-lookup--quick-session nil)
(defvar reference-explorer-source-lookup--active-temporary-preview nil
  "Most recently displayed temporary reference preview.")
(defvar reference-explorer-source-lookup--preview-interaction nil
  "WebKit preview currently promoted for direct user interaction.")
(defvar reference-explorer-source-lookup--preview-interaction-origin-window nil
  "Window to restore after direct WebKit preview interaction.")
(defvar reference-explorer-source-lookup--preview-interaction-request nil
  "Preview a Consult state function must retain while its minibuffer exits.")
(defvar reference-explorer-source-lookup--docset-webkit-warning-shown nil
  "Non-nil after warning once about a WebKit docset preview failure.")
(defvar reference-explorer-source-lookup--docset-webkit-preview-caches
  (make-hash-table :test #'eq)
  "Reusable WebKit previews keyed by their parent graphical frame.")
(defvar-local reference-explorer-source-lookup--docset-preview-file nil
  "Temporary HTML file owned by the current WebKit preview buffer.")
(defvar-local reference-explorer-source-lookup--docset-preview-obsolete-files nil
  "Superseded HTML files awaiting a WebKit `load-finished' event.")
(defvar-local reference-explorer-source-lookup--docset-preview-file-cleanup-timer nil
  "Fallback timer that deletes HTML from superseded WebKit navigations.")
(defvar-local reference-explorer-source-lookup--export-preview-timer nil)
(defvar-local reference-explorer-source-lookup--export-preview nil)
(defvar-local reference-explorer-source-lookup--export-preview-entry nil)
...
(defvar reference-explorer-source-lookup-thesaurus-embark-map (make-sparse-keymap)
  "Embark actions for thesaurus candidates.")

(defvar reference-explorer-source-lookup-docset-embark-map (make-sparse-keymap)
  "Embark actions for docset candidates.")

(defface reference-explorer-source-lookup-preview
  '((t :inherit default))
  "Face used by the temporary Lookup preview child frame."
  :group 'reference-explorer-source-lookup)

(defface reference-explorer-source-lookup-preview-border
...
(defface reference-explorer-source-lookup-quick-current
  '((t :inherit highlight :extend t))
  "Face used for the selected quick Lookup candidate."
  :group 'reference-explorer-source-lookup)

(defface reference-explorer-source-lookup-quick-default
  '((t :inherit reference-explorer-source-lookup-preview))
  "Face used for the quick Lookup candidate list."
  :group 'reference-explorer-source-lookup)

(defface reference-explorer-source-lookup-quick-source
  '((t :inherit shadow))
  "Face used for dictionary names in quick Lookup candidates."
  :group 'reference-explorer-source-lookup)

(defface reference-explorer-source-lookup-source-highlight
  '((t :inherit match))
  "Face used for the source text selected by quick Lookup."
  :group 'reference-explorer-source-lookup)

(defface reference-explorer-source-lookup-preview-match
  '((t :inherit match))
...
(defun reference-explorer-source-lookup--roman-rule-table ()
  "Return Emacs's standard Roman-to-kana transliteration rules."
  (or reference-explorer-source-lookup--roman-rules
      (progn
        ...
        (setq reference-explorer-source-lookup--roman-rules
              (cl-loop
...
(defun reference-explorer-source-lookup--roman-rule-prefix-p (string rules)
...
(defun reference-explorer-source-lookup--roman-to-hiragana (input)
...
using the last complete reading.  A final n is treated as ん for searching."
  (let* ((input (downcase input))
         (rules (reference-explorer-source-lookup--roman-rule-table))
         (max-key-length
        ...
        (cond
         ...
         (t
          ...
          (cond
           ...
           ((reference-explorer-source-lookup--roman-rule-prefix-p remaining rules)
...
(defun reference-explorer-source-lookup--backend-query (input mode)
  "Return the Lookup backend query for INPUT in MODE."
  (let* ((input (string-trim input))
         (query (if (eq mode 'converted)
                    (funcall reference-explorer-source-lookup-query-conversion-function
                             input)
                  input)))
...
(defun reference-explorer-source-lookup--search-entries-with-method (input mode method)
  ...
  (when-let ((backend-query
              (reference-explorer-source-lookup--backend-query input mode)))
...
(defun reference-explorer-source-lookup--quick-query-candidates-at-point ()
...
omitted so moving through this list always has clear expand/shrink semantics."
  (let ((maximum most-positive-fixnum)
    ...
    (dolist (candidate
             (delete-dups
              (reference-explorer-source-lookup-word-candidates-at-point)))
...
(defun reference-explorer-source-lookup--quick-query-options (queries)
...
(defun reference-explorer-source-lookup--docset-candidates (input mode)
...
(defun reference-explorer-source-lookup--docset-annotation (candidate &optional mode)
  "Return a compact kind annotation for docset CANDIDATE in MODE."
  (when-let ((result (reference-explorer-source-lookup-docset-candidate candidate)))
    (concat "  "
            (reference-explorer-source-lookup--candidate-annotation
             result
             (> (length (reference-explorer-source-docset-for-mode mode)) 1)))))

(defun reference-explorer-source-lookup-docset-candidate (candidate)
  "Return the docset result stored in CANDIDATE, or nil."
  (when (stringp candidate)
    (let ((value (or (get-text-property 0 'consult--candidate candidate)
                     (get-text-property 0 'reference-explorer-source-lookup-docset
                                        candidate))))
...
(defun reference-explorer-source-lookup--candidate-label (candidate)
  "Return the visible label for reference CANDIDATE."
  (cond
   ((reference-explorer-source-lookup--thesaurus-candidate-p candidate)
    (reference-explorer-source-thesaurus-result-term
     (reference-explorer-source-lookup--thesaurus-candidate-result candidate)))
...
(defun reference-explorer-source-lookup--docset-kind-symbol (type)
...
(defun reference-explorer-source-lookup--docset-corfu-kind (type)
  "Return the Corfu completion kind corresponding to docset TYPE."
  (pcase (reference-explorer-source-lookup--docset-kind-symbol type)
...
(defun reference-explorer-source-lookup--docset-kind-fallback (type)
  "Return an unambiguous text fallback for docset TYPE."
  (propertize (format "[%s] " (or type "Reference"))
              'face 'reference-explorer-source-lookup-quick-source))

(defun reference-explorer-source-lookup--docset-kind-icon (type)
...
Fall back to an explicit text label when `nerd-icons-corfu' is unavailable."
  (let ((kind (reference-explorer-source-lookup--docset-corfu-kind type)))
    (or
     ...
     (reference-explorer-source-lookup--docset-kind-fallback type))))

(defun reference-explorer-source-lookup--candidate-annotation
...
SHOW-DOCSET-SOURCE keeps the source name when several docsets are searched."
  (cond
   ...
   ((reference-explorer-source-docset-result-p candidate)
    (let ((icon
           (reference-explorer-source-lookup--docset-kind-icon
...
(defun reference-explorer-source-lookup--candidate-preview-entry (candidate)
  "Return a local entry suitable for previewing CANDIDATE."
  (if (or (reference-explorer-source-docset-result-p candidate)
          (not (reference-explorer-source-lookup--thesaurus-candidate-p candidate)))
      candidate
    ...
    (when (fboundp 'lookup-initialize)
      (let ((entries
             (reference-explorer-source-lookup--quick-search-entries
              (reference-explorer-source-lookup--candidate-label candidate))))
...
(defun reference-explorer-source-lookup--preview-query-for-entry (entry query)
...
(defun reference-explorer-source-lookup--highlight-preview-query (query)
      ...
      (let ((case-fold-search t)
        ...
        (while (re-search-forward regexp nil t)
          (add-face-text-property
           ...
           'reference-explorer-source-lookup-preview-match nil))))))

(defun reference-explorer-source-lookup--prepare-preview-buffer (buffer &optional query)
...
Highlight literal QUERY occurrences when QUERY is non-nil."
  (with-current-buffer buffer
    (let ((inhibit-read-only t)
      ...
      (reference-explorer-source-lookup--highlight-preview-query query)
    ...
    (buffer-face-set
     (append
      (list :inherit 'reference-explorer-source-lookup-preview)
      (when (and reference-explorer-source-lookup-content-font-family
                 (find-font
                  (font-spec :family reference-explorer-source-lookup-content-font-family)))
        (list :family reference-explorer-source-lookup-content-font-family))
      (list :height reference-explorer-source-lookup-preview-font-height)))
    buffer))
...
(defun reference-explorer-source-lookup-display-candidate (candidate)
  ...
  (if-let ((entry (reference-explorer-source-lookup-candidate-entry candidate)))
      (reference-explorer-source-lookup--display-entry entry)
...
(defun reference-explorer-source-lookup-display-docset-candidate (candidate)
  "Display the docset result represented by Embark CANDIDATE."
  (if-let ((result (reference-explorer-source-lookup-docset-candidate candidate)))
      (reference-explorer-source-lookup--display-entry result)
    (user-error "Docset result data is unavailable")))

(defun reference-explorer-source-lookup-copy-docset-url (candidate)
...
(defun reference-explorer-source-lookup-browse-docset-candidate (candidate)
...
(defun reference-explorer-source-lookup--display-entry (entry)
  "Render reference ENTRY and display it as committed Popper content."
  (let ((buffer
         (reference-explorer-source-lookup--render-entry
          entry (if (reference-explorer-source-docset-result-p entry)
                    reference-explorer-source-lookup-docset-content-buffer-name
                  reference-explorer-source-lookup-content-buffer-name))))
    (save-selected-window
      (funcall reference-explorer-source-lookup-display-buffer-function buffer))
    buffer))

(defun reference-explorer-source-lookup--face-includes-p (face value)
  "Return non-nil when face VALUE includes FACE."
  (or (eq value face)
      (and (listp value) (memq face value))))

(defun reference-explorer-source-lookup--vertico-selection (display)
  "Return selected Vertico DISPLAY data as (ROW LINE)."
  (let ((position 0)
        selected)
    (while (and (< position (length display)) (null selected))
      (when (reference-explorer-source-lookup--face-includes-p
             'vertico-current
...
(defun reference-explorer-source-lookup--vertico-selected-row (display)
  "Return the visual row of the selected candidate in Vertico DISPLAY."
  (car (reference-explorer-source-lookup--vertico-selection display)))

(defun reference-explorer-source-lookup--vertico-candidate-position ()
  ...
  (when-let* ((minibuffer-window (active-minibuffer-window))
              ...
              (selection (reference-explorer-source-lookup--vertico-selection display))
              (row (car selection))
              (line (cadr selection)))
...
(defun reference-explorer-source-lookup--preview-left (position frame-width side)
  "Return preview left coordinate for POSITION, FRAME-WIDTH and SIDE."
  (if (eq side 'right)
      (car position)
    (max 0 (- (nth 3 position) frame-width 4))))

(defun reference-explorer-source-lookup--preview-text-pixel-size
...
(defun reference-explorer-source-lookup--preview-wrapped-height
...
(defun reference-explorer-source-lookup--preview-horizontal-layout
  ...
  (let* ((right-space (max 0 (nth 2 position)))
         ...
         (width
          (min configured-width
               (max 0 (- space
                         reference-explorer-source-lookup--preview-horizontal-overhead)))))
    (when (>= width minimum-width)
      (cons side width))))

(defun reference-explorer-source-lookup--preview-max-height
...
LINE-HEIGHT is the minimum useful body height."
  (max line-height
       (- parent-height
          reference-explorer-source-lookup--preview-vertical-overhead
          8)))

(defun reference-explorer-source-lookup--preview-top
...
upward only as far as needed to keep its bottom inside the parent frame."
  (max 4
       (min (- (cadr position)
               reference-explorer-source-lookup--preview-border-width)
            (- parent-height frame-height 4))))

(defun reference-explorer-source-lookup--preview-content-width
    (measured-width max-width char-width &optional minimum-width)
  "Return safe content width from MEASURED-WIDTH within MAX-WIDTH.
CHAR-WIDTH converts `reference-explorer-source-lookup-preview-width-slack' to pixels."
  (min max-width
       (max (or minimum-width char-width)
            (+ measured-width
               (* reference-explorer-source-lookup-preview-width-slack char-width)))))

(defun reference-explorer-source-lookup--child-frame-parameters
...
(defun reference-explorer-source-lookup--style-child-frame (frame border-face)
...
(defun reference-explorer-source-lookup--delete-docset-preview-file ()
  "Delete all temporary HTML owned by the current preview buffer."
  (when (timerp reference-explorer-source-lookup--docset-preview-file-cleanup-timer)
    (cancel-timer reference-explorer-source-lookup--docset-preview-file-cleanup-timer))
  (dolist (file (cons reference-explorer-source-lookup--docset-preview-file
                      reference-explorer-source-lookup--docset-preview-obsolete-files))
    (when (and file (file-exists-p file))
      (delete-file file)))
  (setq reference-explorer-source-lookup--docset-preview-file nil
        reference-explorer-source-lookup--docset-preview-obsolete-files nil
        reference-explorer-source-lookup--docset-preview-file-cleanup-timer nil))

(defun reference-explorer-source-lookup--delete-obsolete-docset-preview-files ()
  "Delete superseded HTML after WebKit has finished loading its replacement."
  (when (timerp reference-explorer-source-lookup--docset-preview-file-cleanup-timer)
    (cancel-timer reference-explorer-source-lookup--docset-preview-file-cleanup-timer))
  (dolist (file reference-explorer-source-lookup--docset-preview-obsolete-files)
    (when (file-exists-p file)
      (delete-file file)))
  (setq reference-explorer-source-lookup--docset-preview-obsolete-files nil
        reference-explorer-source-lookup--docset-preview-file-cleanup-timer nil))

(defun reference-explorer-source-lookup--schedule-obsolete-docset-file-cleanup (buffer)
...
the bounded fallback cleanup."
  (when (buffer-live-p buffer)
    (with-current-buffer buffer
      (when (timerp reference-explorer-source-lookup--docset-preview-file-cleanup-timer)
        (cancel-timer reference-explorer-source-lookup--docset-preview-file-cleanup-timer))
      (setq reference-explorer-source-lookup--docset-preview-file-cleanup-timer
            (run-at-time
             0.5 nil
             (lambda (owned-buffer)
...
(defun reference-explorer-source-lookup--docset-webkit-available-p ()
  "Return non-nil when a WebKit docset preview can be created."
  (and (eq reference-explorer-source-lookup-docset-preview-renderer 'webkit)
       (display-graphic-p)
...
(defun reference-explorer-source-lookup--docset-webkit-callback (xwidget event-type)
  ...
  (when (buffer-live-p (xwidget-buffer xwidget))
    (reference-explorer-source-lookup--internalize-docset-webkit-buffer
...
(defun reference-explorer-source-lookup--navigate-docset-webkit (buffer xwidget entry)
  "Render docset ENTRY and navigate reusable XWIDGET in BUFFER to it."
  (let ((file (make-temp-file "reference-explorer-source-lookup-docset-preview-" nil ".html")))
    (unwind-protect
        (progn
          (with-temp-file file
            (insert
             (reference-explorer-source-docset-render-html
              ...
              (format "html { font-size: %spx !important; }"
                      reference-explorer-source-lookup-docset-webkit-font-size))))
          (with-current-buffer buffer
            (when reference-explorer-source-lookup--docset-preview-file
              (push reference-explorer-source-lookup--docset-preview-file
                    reference-explorer-source-lookup--docset-preview-obsolete-files))
            (setq reference-explorer-source-lookup--docset-preview-file file)
            (xwidget-webkit-goto-uri
             xwidget (url-encode-url (concat "file://" file)))
            (reference-explorer-source-lookup--schedule-obsolete-docset-file-cleanup
             buffer)
            (setq file nil)))
      (when (and file (file-exists-p file))
        (delete-file file)))))

(defun reference-explorer-source-lookup--make-docset-webkit-buffer
    (entry width height)
              ...
              (progn
                ...
                (with-current-buffer buffer
                  ...
                  (let ((xwidget
                    ...
                    (add-hook
                     'kill-buffer-hook
                     #'reference-explorer-source-lookup--delete-docset-preview-file
                     nil t)
                    (reference-explorer-source-lookup--navigate-docset-webkit
...
(defun reference-explorer-source-lookup--internalize-docset-webkit-buffer (buffer)
  ...
  (with-current-buffer buffer
    ...
    (unless (string-prefix-p " " (buffer-name))
      (rename-buffer
       (generate-new-buffer-name reference-explorer-source-lookup-preview-buffer-name)
       t)))
  buffer)

(defun reference-explorer-source-lookup--docset-webkit-layout (position anchor-window)
    ...
    (let* ((parent-frame (window-frame anchor-window))
           ...
           (horizontal-layout
            (reference-explorer-source-lookup--preview-horizontal-layout
             position reference-explorer-source-lookup-docset-webkit-preview-width
             reference-explorer-source-lookup-docset-webkit-preview-min-width)))
      (when horizontal-layout
        (list :parent-frame parent-frame
              :side (car horizontal-layout)
              :width (cdr horizontal-layout)
              :height
              (min reference-explorer-source-lookup-docset-webkit-preview-height
                   (reference-explorer-source-lookup--preview-max-height
                    line-height (frame-pixel-height parent-frame))))))))

(defun reference-explorer-source-lookup--docset-webkit-cache (parent-frame)
  "Return the reusable WebKit preview belonging to PARENT-FRAME."
  (gethash parent-frame reference-explorer-source-lookup--docset-webkit-preview-caches))

(defun reference-explorer-source-lookup--cache-docset-webkit-preview
...
(defun reference-explorer-source-lookup--cached-docset-webkit-preview-p (preview)
  "Return non-nil when PREVIEW is its parent frame's reusable WebKit view."
  (and
   (reference-explorer-source-lookup--preview-p preview)
   (let (cached)
     (maphash
...
(defun reference-explorer-source-lookup--uncache-docset-webkit-preview-frame (frame)
  ...
  (let (parent-frame preview)
    (maphash
     (lambda (candidate-parent candidate-preview)
       (when (eq frame (reference-explorer-source-lookup--preview-frame candidate-preview))
         (setq parent-frame candidate-parent
               preview candidate-preview)))
     reference-explorer-source-lookup--docset-webkit-preview-caches)
    (when parent-frame
      (remhash parent-frame reference-explorer-source-lookup--docset-webkit-preview-caches))
    preview))

(defun reference-explorer-source-lookup--display-docset-webkit-preview
  ...
  (let* ((parent-frame (plist-get layout :parent-frame))
         ...
         (cached (reference-explorer-source-lookup--docset-webkit-cache parent-frame))
         (reuse
          (and (reference-explorer-source-lookup--preview-live-p cached)
               (eq (frame-parent
                    (reference-explorer-source-lookup--preview-frame cached))
                   parent-frame)))
         (buffer (and reuse
                      (reference-explorer-source-lookup--preview-buffer cached)))
         (frame (and reuse
                     (reference-explorer-source-lookup--preview-frame cached)))
    ...
    (unwind-protect
        (progn
          (unless (and reuse (window-live-p window) xwidget)
            (let* ((resources
                    (reference-explorer-source-lookup--make-docset-webkit-buffer
                     entry body-width body-height))
                   (parameters
                    (reference-explorer-source-lookup--child-frame-parameters
                     parent-frame 'reference-explorer-source-lookup-preview
                     reference-explorer-source-lookup--preview-border-width))
                   (shown-window
                    (save-selected-window
          ...
          (reference-explorer-source-lookup--internalize-docset-webkit-buffer buffer)
          ...
          (let* ((frame-width
                 ...
                 (frame-height
                  (+ body-height
                     reference-explorer-source-lookup--preview-vertical-overhead))
                 (left
                  (reference-explorer-source-lookup--preview-left
                   position frame-width (plist-get layout :side)))
                 (top
                  (reference-explorer-source-lookup--preview-top
                   position frame-height (frame-pixel-height parent-frame))))
            (set-window-dedicated-p window t)
            (set-frame-size frame frame-width frame-height t)
            (set-frame-parameter
             frame 'reference-explorer-source-lookup-preview-buffer buffer)
            (set-frame-position frame left top)
            (redirect-frame-focus frame parent-frame)
            (reference-explorer-source-lookup--style-child-frame
             frame 'reference-explorer-source-lookup-preview-border)
            ...
            (setf (reference-explorer-source-lookup--preview-entry preview) entry)
...
(defun reference-explorer-source-lookup--show-docset-webkit-preview-at-position
    (entry position anchor-window)
  "Show an isolated WebKit docset ENTRY beside POSITION in ANCHOR-WINDOW."
  (when (reference-explorer-source-lookup--docset-webkit-available-p)
    (condition-case error-data
        (when-let ((layout
                    (reference-explorer-source-lookup--docset-webkit-layout
                     position anchor-window)))
          (reference-explorer-source-lookup--display-docset-webkit-preview
           entry position layout))
      (error
       (unless reference-explorer-source-lookup--docset-webkit-warning-shown
         (setq reference-explorer-source-lookup--docset-webkit-warning-shown t)
         (display-warning
...
(defun reference-explorer-source-lookup--show-temporary-shr-preview-at-position
    ...
    (when-let* (((window-live-p anchor-window))
                ...
                (configured-width
                 (* (if (eq preview-kind 'docset)
                        reference-explorer-source-lookup-docset-preview-max-width
                      reference-explorer-source-lookup-preview-max-width)
                    char-width))
                (minimum-width
                 (* (if (eq preview-kind 'docset)
                        reference-explorer-source-lookup-docset-preview-min-width
                      reference-explorer-source-lookup-preview-min-width)
                    char-width))
                (margin-pixels
                 (* 2 reference-explorer-source-lookup-preview-margin-width char-width))
                (horizontal-layout
                 (reference-explorer-source-lookup--preview-horizontal-layout
                  position
                ...
                (buffer-name
                 (generate-new-buffer-name
                  reference-explorer-source-lookup-preview-buffer-name))
                (buffer
                 (reference-explorer-source-lookup--prepare-preview-buffer
        ...
        (unwind-protect
            (let ((parameters
              ...
              (when-let*
                ...
                (set-window-margins
                 window reference-explorer-source-lookup-preview-margin-width
                 reference-explorer-source-lookup-preview-margin-width)
                (let* ((line-height
                       ...
                       (max-height
                        (min (reference-explorer-source-lookup--preview-max-height
                              line-height parent-height)
                             (if (eq preview-kind 'docset)
                                 (* reference-explorer-source-lookup-docset-preview-max-height
                                    line-height)
                               parent-height)))
                       (_initial-size
                        (set-frame-size
                       ...
                       (size
                        (reference-explorer-source-lookup--preview-text-pixel-size
                         window buffer max-width max-height))
                       (width
                        (reference-explorer-source-lookup--preview-content-width
                  ...
                  (setq preview
                        (reference-explorer-source-lookup--make-preview
                         frame buffer entry))
                  (setq reference-explorer-source-lookup--active-temporary-preview
                        preview)
...
(defun reference-explorer-source-lookup--show-temporary-preview-at-position
    (entry position anchor-window &optional query)
  ...
  (or (and (reference-explorer-source-docset-result-p entry)
           (reference-explorer-source-lookup--show-docset-webkit-preview-at-position
            entry position anchor-window))
      (reference-explorer-source-lookup--show-temporary-shr-preview-at-position
       entry position anchor-window query)))

(defun reference-explorer-source-lookup--show-temporary-preview (entry)
  "Show ENTRY beside the selected Consult candidate."
  (when-let ((minibuffer-window (active-minibuffer-window))
             (position (reference-explorer-source-lookup--vertico-candidate-position)))
    (let ((query
           (with-current-buffer (window-buffer minibuffer-window)
             (reference-explorer-source-lookup--backend-query
              (minibuffer-contents-no-properties)
              reference-explorer-source-lookup--active-consult-mode))))
      (reference-explorer-source-lookup--show-temporary-preview-at-position
       entry position minibuffer-window query))))

(defun reference-explorer-source-lookup--preview-frame-deleted (frame)
  ...
  (when-let ((buffer
    ...
    (when-let ((cached
                (reference-explorer-source-lookup--uncache-docset-webkit-preview-frame
                 frame)))
      (when (eq cached reference-explorer-source-lookup--active-temporary-preview)
        (setq reference-explorer-source-lookup--active-temporary-preview nil))
      (when (eq cached reference-explorer-source-lookup--preview-interaction)
        (setq reference-explorer-source-lookup--preview-interaction nil
              reference-explorer-source-lookup--preview-interaction-origin-window nil)))
    ...
    (run-at-time
     ...
     (lambda (owned-buffer)
       (when (buffer-live-p owned-buffer)
         (reference-explorer-source-lookup--delete-xwidget-views owned-buffer)
         (reference-explorer-source-lookup--retire-preview-buffer owned-buffer)))
     buffer)))

(defun reference-explorer-source-lookup--delete-xwidget-views (buffer)
...
(defun reference-explorer-source-lookup--retire-preview-buffer (buffer)
  "Kill non-cached preview BUFFER."
  (when (buffer-live-p buffer)
    (kill-buffer buffer)))

(defun reference-explorer-source-lookup--close-temporary-preview (preview)
  "Delete temporary Lookup PREVIEW and all resources it owns."
  (when (reference-explorer-source-lookup--preview-p preview)
    (when (eq preview reference-explorer-source-lookup--active-temporary-preview)
      (setq reference-explorer-source-lookup--active-temporary-preview nil))
    (let ((frame (reference-explorer-source-lookup--preview-frame preview))
          (buffer (reference-explorer-source-lookup--preview-buffer preview)))
      (if (reference-explorer-source-lookup--cached-docset-webkit-preview-p preview)
        ...
        (when (frame-live-p frame)
          (delete-frame frame))
        (reference-explorer-source-lookup--delete-xwidget-views buffer)
        (reference-explorer-source-lookup--retire-preview-buffer buffer)))))

(defun reference-explorer-source-lookup--preview-live-p (preview)
  "Return non-nil when PREVIEW still owns a live frame and buffer."
  (and (reference-explorer-source-lookup--preview-p preview)
       (frame-live-p (reference-explorer-source-lookup--preview-frame preview))
       (buffer-live-p (reference-explorer-source-lookup--preview-buffer preview))))

(defun reference-explorer-source-lookup--scroll-temporary-preview (direction)
  "Scroll the active temporary preview in DIRECTION.
DIRECTION is `up' to reveal later text or `down' to reveal earlier text."
  (let ((preview reference-explorer-source-lookup--active-temporary-preview))
    (unless (reference-explorer-source-lookup--preview-live-p preview)
...
(defun reference-explorer-source-lookup-preview-scroll-up ()
  "Scroll the temporary reference preview toward later text."
  (interactive)
  (reference-explorer-source-lookup--scroll-temporary-preview 'up))

(defun reference-explorer-source-lookup-preview-scroll-down ()
  "Scroll the temporary reference preview toward earlier text."
  (interactive)
  (reference-explorer-source-lookup--scroll-temporary-preview 'down))

(defun reference-explorer-source-lookup--active-webkit-preview-xwidget ()
  "Return the xwidget displayed by the active WebKit preview, or nil."
  (when (reference-explorer-source-lookup--preview-live-p
         reference-explorer-source-lookup--active-temporary-preview)
    (let ((buffer
           (reference-explorer-source-lookup--preview-buffer
            reference-explorer-source-lookup--active-temporary-preview)))
      (when (and (buffer-live-p buffer)
...
(defun reference-explorer-source-lookup-preview-copy-selection ()
  "Copy the active WebKit preview selection to the kill ring and clipboard."
  (interactive)
  (if-let ((xwidget (reference-explorer-source-lookup--active-webkit-preview-xwidget)))
...
(defvar-keymap reference-explorer-source-lookup-preview-interaction-mode-map
  :doc "Keymap active while directly operating a reference WebKit preview."
  "C-g" #'reference-explorer-source-lookup-preview-exit-interaction
  "H-q" #'reference-explorer-source-lookup-preview-exit-interaction
  "H-w" #'reference-explorer-source-lookup-preview-copy-selection
  "M-w" #'reference-explorer-source-lookup-preview-copy-selection)

(define-minor-mode reference-explorer-source-lookup-preview-interaction-mode
  "Allow direct mouse and keyboard operation of a reference WebKit preview."
  :init-value nil
  :lighter " RefInteract"
  :keymap reference-explorer-source-lookup-preview-interaction-mode-map)

(defun reference-explorer-source-lookup--activate-webkit-preview-interaction
    (preview origin-window)
  "Promote WebKit PREVIEW for direct interaction, returning to ORIGIN-WINDOW."
  (unless (and (eq preview reference-explorer-source-lookup--active-temporary-preview)
               (reference-explorer-source-lookup--preview-live-p preview)
  ...
  (let* ((frame (reference-explorer-source-lookup--preview-frame preview))
         (buffer (reference-explorer-source-lookup--preview-buffer preview)))
    (setq reference-explorer-source-lookup--preview-interaction preview
          reference-explorer-source-lookup--preview-interaction-origin-window
          origin-window
          reference-explorer-source-lookup--active-temporary-preview preview)
    (with-current-buffer buffer
      (reference-explorer-source-lookup-preview-interaction-mode 1))
...
(defun reference-explorer-source-lookup--display-entry-for-interaction
    (entry origin-window)
...
(defun reference-explorer-source-lookup--activate-preview-interaction
    (preview origin-window)
...
committed to a selected Popper window."
  (unless (reference-explorer-source-lookup--preview-p preview)
    (user-error "No reference preview is available"))
  (if (and (eq preview reference-explorer-source-lookup--active-temporary-preview)
           (reference-explorer-source-lookup--preview-live-p preview)
           (reference-explorer-source-lookup--active-webkit-preview-xwidget))
      (reference-explorer-source-lookup--activate-webkit-preview-interaction
       preview origin-window)
    (if-let ((entry (reference-explorer-source-lookup--preview-entry preview)))
        (reference-explorer-source-lookup--display-entry-for-interaction
         entry origin-window)
      (user-error "The reference preview has no operable content"))))

(defun reference-explorer-source-lookup-preview-exit-interaction ()
  "End direct WebKit preview interaction and return to its origin window."
  (interactive)
  (let ((preview reference-explorer-source-lookup--preview-interaction)
        (origin-window reference-explorer-source-lookup--preview-interaction-origin-window))
    (setq reference-explorer-source-lookup--preview-interaction nil
          reference-explorer-source-lookup--preview-interaction-origin-window nil)
    (when (reference-explorer-source-lookup--preview-p preview)
      (let ((frame (reference-explorer-source-lookup--preview-frame preview))
...
(add-hook 'delete-frame-functions
          #'reference-explorer-source-lookup--preview-frame-deleted)

(defun reference-explorer-source-lookup--preview-state ()
  "Return a Consult state function for temporary Lookup previews."
  (let (preview)
    (lambda (action entry)
      (when preview
        (if (eq preview reference-explorer-source-lookup--preview-interaction-request)
            (setq reference-explorer-source-lookup--preview-interaction-request nil)
          (reference-explorer-source-lookup--close-temporary-preview preview))
        (setq preview nil))
      (pcase action
        ('preview
         (when entry
           (setq preview
                 (reference-explorer-source-lookup--show-temporary-preview entry))))))))

;; Corfu-like quick selector

(defun reference-explorer-source-lookup--quick-current-entry (&optional session)
  "Return the selected entry in quick Lookup SESSION."
  (let ((session (or session reference-explorer-source-lookup--quick-session)))
    (and session
         (nth (reference-explorer-source-lookup--quick-session-index session)
              (reference-explorer-source-lookup--quick-session-entries session)))))

(defun reference-explorer-source-lookup--quick-show-help (&optional status)
  "Show a compact quick Lookup key summary in the minibuffer.
Prefix the summary with STATUS when it is non-nil."
  (message "%s%s"
           (if status (concat status " — ") "")
           (or (and reference-explorer-source-lookup--quick-session
                    (reference-explorer-source-lookup--quick-session-help
                     reference-explorer-source-lookup--quick-session))
               "H-s/e:検索語を縮小/拡大  H-i:preview操作  M-m:Consult")))

(defun reference-explorer-source-lookup--quick-visible-entries (session)
  "Return visible entries for quick Lookup SESSION and update its offset."
  (let* ((entries (reference-explorer-source-lookup--quick-session-entries session))
         (count (length entries))
         (limit (max 1 reference-explorer-source-lookup-quick-max-candidates))
         (index (reference-explorer-source-lookup--quick-session-index session))
    ...
    (setf (reference-explorer-source-lookup--quick-session-list-offset session) offset)
    (seq-subseq entries offset end)))

(defun reference-explorer-source-lookup--quick-candidate-line
...
Selection styling is applied by the renderer across the complete visual row."
  (let* ((docset-p (reference-explorer-source-docset-result-p entry))
         (heading (reference-explorer-source-lookup--candidate-label entry))
         (annotation
          (reference-explorer-source-lookup--candidate-annotation
           entry nil))
         (docset-source
              ...
              (concat annotation heading
                      (if docset-source
                          (concat "  "
                                  (propertize
                                   docset-source 'face
                                   'reference-explorer-source-lookup-quick-source))
                        ""))
            (concat heading
...
(defconst reference-explorer-source-lookup--quick-fringe-bitmap
  'reference-explorer-source-lookup--quick-fringe-bitmap)
...
(when (fboundp 'define-fringe-bitmap)
  ...
  (define-fringe-bitmap reference-explorer-source-lookup--quick-fringe-bitmap [0] 1 1))

(defconst reference-explorer-source-lookup--quick-current-fringes
  (propertize
   "  "
   'display nil)
...
(put-text-property
 0 1 'display
 `(left-fringe ,reference-explorer-source-lookup--quick-fringe-bitmap
               reference-explorer-source-lookup-quick-current)
 reference-explorer-source-lookup--quick-current-fringes)
(put-text-property
 1 2 'display
 `(right-fringe ,reference-explorer-source-lookup--quick-fringe-bitmap
                reference-explorer-source-lookup-quick-current)
 reference-explorer-source-lookup--quick-current-fringes)

(defun reference-explorer-source-lookup--quick-render-list (session)
  "Render quick Lookup SESSION into its candidate buffer."
  (let* ((buffer (reference-explorer-source-lookup--quick-session-list-buffer session))
         (index (reference-explorer-source-lookup--quick-session-index session))
         (visible (reference-explorer-source-lookup--quick-visible-entries session))
         (show-docset-source
          (> (length
              (delete-dups
               (delq nil
                      ...
                      (lambda (entry)
                        (and (reference-explorer-source-docset-result-p entry)
                             (reference-explorer-source-docset-root
                              (reference-explorer-source-docset-result-docset entry))))
                      (reference-explorer-source-lookup--quick-session-entries
                       session)))))
             1))
         (offset (reference-explorer-source-lookup--quick-session-list-offset session)))
    (with-current-buffer buffer
      (let ((inhibit-read-only t))
        (erase-buffer)
        (cl-loop for entry in visible
                 ...
                 do (let ((start (point)))
                      (insert
                       (reference-explorer-source-lookup--quick-candidate-line
                        entry selected show-docset-source))
                      (when (and selected (display-graphic-p))
                        (insert reference-explorer-source-lookup--quick-current-fringes))
                      (insert "\n")
                      ...
                      (when selected
                        (add-face-text-property
                         start (point)
                         'reference-explorer-source-lookup-quick-current 'append))))
        (when (null visible)
      ...
      (setq-local mode-line-format nil
                  ...
                  truncate-lines t
                  buffer-read-only t)
      (buffer-face-set 'reference-explorer-source-lookup-quick-default))))

(defun reference-explorer-source-lookup--quick-query-bounds (session)
  "Return source-buffer bounds of SESSION's active query."
  (or (reference-explorer-source-lookup--quick-session-source-bounds session)
      (when-let* ((marker
                   (reference-explorer-source-lookup--quick-session-source-marker session))
                  (buffer (and (markerp marker) (marker-buffer marker)))
                  (query (reference-explorer-source-lookup--quick-session-query session)))
        (with-current-buffer buffer
          (save-excursion
            (goto-char marker)
            (or
             (seq-find
              ...
              (reference-explorer-source-lookup-word-bound-candidates-at-point))
             (let ((origin (point))
...
(defun reference-explorer-source-lookup--quick-highlight-source (session)
  ...
  (when-let ((overlay
    ...
    (setf (reference-explorer-source-lookup--quick-session-source-overlay session) nil))
  (when-let* ((marker
               (reference-explorer-source-lookup--quick-session-source-marker session))
              (buffer (and (markerp marker) (marker-buffer marker)))
              (bounds (reference-explorer-source-lookup--quick-query-bounds session)))
    (let ((overlay (make-overlay (car bounds) (cdr bounds) buffer)))
      (overlay-put overlay 'face 'reference-explorer-source-lookup-source-highlight)
      (overlay-put overlay 'priority 100)
      (setf (reference-explorer-source-lookup--quick-session-source-overlay session)
            overlay))))

(defun reference-explorer-source-lookup--quick-sync-list-window (session)
  "Synchronize SESSION's child window with its freshly rendered buffer."
  (when-let* ((frame (reference-explorer-source-lookup--quick-session-list-frame session))
              ((frame-live-p frame))
              (window (frame-selected-window frame))
              ((window-live-p window))
              (buffer (reference-explorer-source-lookup--quick-session-list-buffer
                       session))
...
(defun reference-explorer-source-lookup--quick-point-position (window)
...
(defun reference-explorer-source-lookup--quick-position-list-frame (session)
  "Position quick Lookup SESSION's candidate frame near source point."
  (when-let* ((frame (reference-explorer-source-lookup--quick-session-list-frame session))
              ((frame-live-p frame))
              (source-window
               (reference-explorer-source-lookup--quick-session-source-window session))
              (position
               (reference-explorer-source-lookup--quick-point-position source-window)))
...
(defun reference-explorer-source-lookup--quick-resize-list-frame (session)
  "Resize and position quick Lookup SESSION's candidate frame."
  (when-let* ((frame (reference-explorer-source-lookup--quick-session-list-frame session))
              ((frame-live-p frame))
              (buffer (reference-explorer-source-lookup--quick-session-list-buffer session))
              ((buffer-live-p buffer)))
    (let* ((window (frame-selected-window frame))
           (char-width (frame-char-width frame))
           (max-width (* reference-explorer-source-lookup-quick-max-width char-width))
      ...
      (reference-explorer-source-lookup--quick-sync-list-window session))))

(defun reference-explorer-source-lookup--quick-candidate-position (session)
...
(defun reference-explorer-source-lookup--quick-cancel-preview (session)
  "Cancel and close SESSION's pending and visible temporary preview."
  (when-let ((timer
              (reference-explorer-source-lookup--quick-session-preview-timer session)))
    (when (timerp timer)
      (cancel-timer timer))
    (setf (reference-explorer-source-lookup--quick-session-preview-timer session) nil))
  (when-let ((preview
              (reference-explorer-source-lookup--quick-session-preview session)))
    (reference-explorer-source-lookup--close-temporary-preview preview)
    (setf (reference-explorer-source-lookup--quick-session-preview session) nil)))

(defun reference-explorer-source-lookup--quick-show-preview (session entry)
  "Show ENTRY preview when SESSION is still the active quick Lookup."
  (setf (reference-explorer-source-lookup--quick-session-preview-timer session) nil)
  (when (eq session reference-explorer-source-lookup--quick-session)
    (when-let ((preview-entry
                (reference-explorer-source-lookup--candidate-preview-entry entry))
               (position
                (reference-explorer-source-lookup--quick-candidate-position session)))
      (setf (reference-explorer-source-lookup--quick-session-preview session)
            (reference-explorer-source-lookup--show-temporary-preview-at-position
             preview-entry position
             (reference-explorer-source-lookup--quick-session-source-window session)
             (reference-explorer-source-lookup--candidate-label entry)))
      ;; Lookup reports its content insertion in the echo area.  Restore the
      ;; compact selector hint after rendering finishes.
      (reference-explorer-source-lookup--quick-show-help))))

(defun reference-explorer-source-lookup--quick-schedule-preview (session)
  "Schedule a preview for the selected entry in SESSION."
  (reference-explorer-source-lookup--quick-cancel-preview session)
  (when-let ((entry (reference-explorer-source-lookup--quick-current-entry session)))
    (setf (reference-explorer-source-lookup--quick-session-preview-timer session)
          (run-at-time reference-explorer-source-lookup-preview-debounce nil
                       #'reference-explorer-source-lookup--quick-show-preview
                       session entry))))

(defun reference-explorer-source-lookup--quick-refresh (session)
  ...
  (reference-explorer-source-lookup--quick-resize-list-frame session)
  (reference-explorer-source-lookup--quick-schedule-preview session)
  (reference-explorer-source-lookup--quick-show-help))

(defun reference-explorer-source-lookup--quick-show-list-frame (session)
  ...
  (when (and (display-graphic-p)
    ...
    (let* ((buffer (generate-new-buffer " *Lookup Quick*"))
           ...
           (left-margin
            (min 16
                 (ceiling
                  (* char-width reference-explorer-source-lookup-quick-left-margin-width))))
           (right-margin
            (min 16
                 (ceiling
                  (* char-width reference-explorer-source-lookup-quick-right-margin-width))))
           (parameters
            (reference-explorer-source-lookup--child-frame-parameters
             parent 'reference-explorer-source-lookup-quick-default 1)))
      (setf (alist-get 'left-fringe parameters) left-margin
            (alist-get 'right-fringe parameters) right-margin)
      (setf (reference-explorer-source-lookup--quick-session-list-buffer session) buffer)
      (reference-explorer-source-lookup--quick-render-list session)
      (when-let ((window
                  (save-selected-window
                    (let ((display-buffer-overriding-action nil)
        ...
        (let ((frame (window-frame window)))
          (set-window-dedicated-p window t)
          (redirect-frame-focus frame parent)
          (setf (reference-explorer-source-lookup--quick-session-list-frame session)
                frame)
          (set-frame-parameter frame 'reference-explorer-source-lookup-quick-session
                               session)
          (reference-explorer-source-lookup--quick-resize-list-frame session)
          (reference-explorer-source-lookup--style-child-frame
           frame 'reference-explorer-source-lookup-preview-border)
...
(defun reference-explorer-source-lookup--quick-list-frame-deleted (frame)
  "Deactivate quick Lookup when its candidate FRAME is deleted externally."
  (when-let ((session reference-explorer-source-lookup--quick-session))
    (when (eq frame
              (reference-explorer-source-lookup--quick-session-list-frame session))
      ;; `delete-frame-functions' runs during frame deletion.  Forget FRAME
      ;; now, then deactivate after deletion has completely unwound.
      (setf (reference-explorer-source-lookup--quick-session-list-frame session) nil)
      (run-at-time
       0 nil
       (lambda (owned-session)
         (when (eq owned-session reference-explorer-source-lookup--quick-session)
           (if-let ((exit
                     (reference-explorer-source-lookup--quick-session-exit-function
                      owned-session)))
               (funcall exit)
...
(add-hook 'delete-frame-functions
          #'reference-explorer-source-lookup--quick-list-frame-deleted)

(defun reference-explorer-source-lookup--quick-cleanup ()
  "Release all resources owned by the active quick Lookup session."
  (when-let ((session reference-explorer-source-lookup--quick-session))
    (setq reference-explorer-source-lookup--quick-session nil)
    (reference-explorer-source-lookup--quick-cancel-preview session)
    (when-let ((overlay
                (reference-explorer-source-lookup--quick-session-source-overlay session)))
      (delete-overlay overlay)
    ...
    (when-let ((marker
      ...
      (setf (reference-explorer-source-lookup--quick-session-source-marker session) nil))
    (when-let ((frame
                (reference-explorer-source-lookup--quick-session-list-frame session)))
      (when (frame-live-p frame)
        (delete-frame frame)))
    (when-let ((buffer
                (reference-explorer-source-lookup--quick-session-list-buffer session)))
      (when (buffer-live-p buffer)
        (kill-buffer buffer)))))

(defun reference-explorer-source-lookup-quick-quit ()
  "Exit quick Lookup and close its temporary displays."
  (interactive)
  (when-let ((session reference-explorer-source-lookup--quick-session))
    (if-let ((exit
              (reference-explorer-source-lookup--quick-session-exit-function session)))
        (funcall exit)
      (reference-explorer-source-lookup--quick-cleanup))))

(defun reference-explorer-source-lookup-quick-next (&optional backward)
  "Select the next quick Lookup entry, or the previous one with BACKWARD."
  (interactive)
  (when-let ((session reference-explorer-source-lookup--quick-session))
    (let ((count
           (length (reference-explorer-source-lookup--quick-session-entries session))))
      (when (> count 0)
        (setf (reference-explorer-source-lookup--quick-session-index session)
              (mod (+ (reference-explorer-source-lookup--quick-session-index session)
                      (if backward -1 1))
                   count))
        (reference-explorer-source-lookup--quick-refresh session)))))

(defun reference-explorer-source-lookup-quick-previous ()
  "Select the previous quick Lookup entry."
  (interactive)
  (reference-explorer-source-lookup-quick-next t))

(defun reference-explorer-source-lookup--quick-change-query (delta)
  "Move DELTA steps through the active quick Lookup query options."
  (when-let ((session reference-explorer-source-lookup--quick-session))
    (let* ((options
            (reference-explorer-source-lookup--quick-session-query-options session))
           (old-index
            (or (reference-explorer-source-lookup--quick-session-query-index session) 0))
      ...
      (if (= old-index new-index)
        ...
        (pcase-let ((`(,query . ,entries) (nth new-index options)))
          (setf (reference-explorer-source-lookup--quick-session-query-index session)
                new-index
                (reference-explorer-source-lookup--quick-session-query session) query
                (reference-explorer-source-lookup--quick-session-entries session) entries
                (reference-explorer-source-lookup--quick-session-index session) 0
                (reference-explorer-source-lookup--quick-session-list-offset session) 0)
          (reference-explorer-source-lookup--quick-refresh session))))))

(defun reference-explorer-source-lookup-quick-shorten-query ()
  "Use the next shorter contextual word around the original point."
  (interactive)
  (reference-explorer-source-lookup--quick-change-query 1))

(defun reference-explorer-source-lookup-quick-expand-query ()
  "Use the next longer contextual word around the original point."
  (interactive)
  (reference-explorer-source-lookup--quick-change-query -1))

(defun reference-explorer-source-lookup-quick-display-entry ()
  "Accept the selected quick candidate using its session action."
  (interactive)
  (when-let ((session reference-explorer-source-lookup--quick-session)
             (entry (reference-explorer-source-lookup--quick-current-entry)))
    (reference-explorer-source-lookup--quick-cancel-preview session)
    (if-let ((accept
              (reference-explorer-source-lookup--quick-session-accept-function session)))
        (progn
...
(defun reference-explorer-source-lookup-quick-open-consult ()
  "Continue the active quick Lookup query in the Consult interface."
  (interactive)
  (when-let ((session reference-explorer-source-lookup--quick-session))
    (if-let ((continue
              (reference-explorer-source-lookup--quick-session-consult-function session)))
        (let ((entries
               (reference-explorer-source-lookup--quick-session-entries session)))
          (reference-explorer-source-lookup-quick-quit)
          (funcall continue entries))
      (when-let ((query
                  (reference-explorer-source-lookup--quick-session-query session)))
        (let ((queries
               (mapcar #'car
                       (reference-explorer-source-lookup--quick-session-query-options
                        session))))
          (reference-explorer-source-lookup-quick-quit)
          (reference-explorer-source-lookup--consult-loop query 'literal queries))))))

(defun reference-explorer-source-lookup-quick-activate-preview ()
  "Close quick candidates and promote their preview for interaction."
  (interactive)
  (let ((session reference-explorer-source-lookup--quick-session))
    (unless session
      (user-error "No quick Lookup session is active"))
    (let* ((candidate (reference-explorer-source-lookup--quick-current-entry session))
           (entry (and candidate
                       (reference-explorer-source-lookup--candidate-preview-entry
                        candidate)))
           (preview
            (or (reference-explorer-source-lookup--quick-session-preview session)
                (and entry
                     (reference-explorer-source-lookup--make-preview nil nil entry)))))
      (unless preview
      ...
      (let ((origin-window
        ...
        (when (and (eq preview reference-explorer-source-lookup--active-temporary-preview)
                   (reference-explorer-source-lookup--active-webkit-preview-xwidget))
          (setf (reference-explorer-source-lookup--quick-session-preview session) nil))
        (if-let ((exit
                  (reference-explorer-source-lookup--quick-session-exit-function session)))
...
(defun reference-explorer-source-lookup--quick-context ()
  "Return a reference context for the active quick Lookup query."
  (when-let ((session reference-explorer-source-lookup--quick-session))
    (reference-explorer-context-create
     :query (reference-explorer-source-lookup--quick-session-query session)
     :marker (reference-explorer-source-lookup--quick-session-source-marker session)
     :window (reference-explorer-source-lookup--quick-session-source-window session))))

(defun reference-explorer-source-lookup--quick-run-provider (&optional provider)
  "Open the active quick Lookup query through PROVIDER or configured order."
  (let ((context (reference-explorer-source-lookup--quick-context)))
    (unless context
      (user-error "No quick Lookup session is active"))
    (if provider
...
(defun reference-explorer-source-lookup-quick-open-reference ()
  "Open the active quick Lookup query with the configured provider order."
  (interactive)
  (reference-explorer-source-lookup--quick-run-provider))

(defun reference-explorer-source-lookup-quick-macos-dictionary ()
  "Forward the active quick Lookup query to macOS Dictionary."
  (interactive)
  (reference-explorer-source-lookup--quick-run-provider 'macos-dictionary))

(defun reference-explorer-source-lookup-quick-monokakido ()
  "Forward the active quick Lookup query to Dictionaries by Monokakido."
  (interactive)
  (reference-explorer-source-lookup--quick-run-provider 'monokakido))

(defvar-keymap reference-explorer-source-lookup-quick-map
  :doc "Transient keymap active during quick Lookup."
  "H-n" #'reference-explorer-source-lookup-quick-next
  "H-p" #'reference-explorer-source-lookup-quick-previous
  "H-s" #'reference-explorer-source-lookup-quick-shorten-query
  "H-e" #'reference-explorer-source-lookup-quick-expand-query
  "H-v" #'reference-explorer-source-lookup-preview-scroll-up
  "H-V" #'reference-explorer-source-lookup-preview-scroll-down
  "H-i" #'reference-explorer-source-lookup-quick-activate-preview
  "H-q" #'reference-explorer-source-lookup-quick-quit
  "C-g" #'reference-explorer-source-lookup-quick-quit
  "TAB" #'reference-explorer-source-lookup-quick-display-entry
  "<tab>" #'reference-explorer-source-lookup-quick-display-entry
  "H-." #'reference-explorer-source-lookup-quick-open-reference
  "M-m" #'reference-explorer-source-lookup-quick-open-consult)
...
(defun reference-explorer-source-lookup--quick-start
  ...
  (let* ((query-options
          (reference-explorer-source-lookup--quick-query-options queries))
    ...
    (cond
     ...
     (t
      (let ((entries (cdar query-options)))
        (reference-explorer-source-lookup--quick-open-session
...
(defun reference-explorer-source-lookup--quick-open-session (session)
  "Open the already populated quick candidate SESSION."
  (reference-explorer-source-lookup--quick-cleanup)
  (setq reference-explorer-source-lookup--quick-session session)
  (if (not (reference-explorer-source-lookup--quick-show-list-frame session))
      (progn
        (reference-explorer-source-lookup--quick-cleanup)
    ...
    (setf
     (reference-explorer-source-lookup--quick-session-exit-function session)
     (set-transient-map reference-explorer-source-lookup-quick-map t
                        #'reference-explorer-source-lookup--quick-cleanup))
    (reference-explorer-source-lookup--quick-highlight-source session)
    (reference-explorer-source-lookup--quick-schedule-preview session)
    (reference-explorer-source-lookup--quick-show-help)))
...
(defun reference-explorer-source-lookup--thesaurus-candidate-value (candidate)
  "Return the thesaurus target stored in CANDIDATE."
  (cond
   ((reference-explorer-source-lookup--thesaurus-candidate-p candidate) candidate)
   ((stringp candidate)
    (or (get-text-property 0 'consult--candidate candidate)
        (let ((position
               (next-single-property-change
...
(defun reference-explorer-source-lookup--thesaurus-term (candidate)
  "Return the term represented by thesaurus CANDIDATE."
  (when-let ((target
              (reference-explorer-source-lookup--thesaurus-candidate-value candidate)))
    (reference-explorer-source-thesaurus-result-term
     (reference-explorer-source-lookup--thesaurus-candidate-result target))))

(defun reference-explorer-source-lookup--preserve-word-case (replacement original)
...
(defun reference-explorer-source-lookup-thesaurus-replace (candidate)
  ...
  (let* ((target
         ...
         (buffer
          (and target
               (reference-explorer-source-lookup--thesaurus-candidate-buffer target)))
         (beginning
          (and target
               (reference-explorer-source-lookup--thesaurus-candidate-beginning target)))
         (end
          (and target
               (reference-explorer-source-lookup--thesaurus-candidate-end target)))
         (original
          (and target
               (reference-explorer-source-lookup--thesaurus-candidate-original target)))
         (term (reference-explorer-source-lookup--thesaurus-term target)))
    ...
    (with-current-buffer buffer
      (let ((start (marker-position beginning))
        ...
        (let ((replacement
               (reference-explorer-source-lookup--preserve-word-case term original)))
          (atomic-change-group
            (goto-char start)
...
(defun reference-explorer-source-lookup-thesaurus-copy (candidate)
  "Copy the term represented by thesaurus CANDIDATE."
  (interactive)
  (if-let ((term (reference-explorer-source-lookup--thesaurus-term candidate)))
      (progn (kill-new term) (message "Copied thesaurus term: %s" term))
    (user-error "Thesaurus candidate data is unavailable")))

(defun reference-explorer-source-lookup--thesaurus-run-provider (candidate provider)
...
(defun reference-explorer-source-lookup-thesaurus-lookup (candidate)
  "Open thesaurus CANDIDATE with GNU Lookup."
  (interactive)
  (reference-explorer-source-lookup--thesaurus-run-provider candidate 'lookup))

(defun reference-explorer-source-lookup-thesaurus-macos-dictionary (candidate)
  "Open thesaurus CANDIDATE with macOS Dictionary."
  (interactive)
  (reference-explorer-source-lookup--thesaurus-run-provider candidate 'macos-dictionary))

(defun reference-explorer-source-lookup-thesaurus-monokakido (candidate)
  "Open thesaurus CANDIDATE with Dictionaries by Monokakido."
  (interactive)
  (reference-explorer-source-lookup--thesaurus-run-provider candidate 'monokakido))

(defun reference-explorer-source-lookup--thesaurus-consult-candidate (target id)
  "Return a Consult string for thesaurus TARGET disambiguated by ID."
  (let* ((term (reference-explorer-source-lookup--thesaurus-term target))
...
(defun reference-explorer-source-lookup--thesaurus-annotation (candidate)
  "Return an annotation for the thesaurus Consult CANDIDATE."
  (when-let ((target
              (reference-explorer-source-lookup--thesaurus-candidate-value candidate)))
    (let ((annotation
           (reference-explorer-source-lookup--candidate-annotation target)))
      (unless (string-empty-p annotation)
        (concat "  " annotation)))))

(defun reference-explorer-source-lookup--thesaurus-preview-state ()
  ...
  (let (preview)
    (lambda (action candidate)
      ...
      (when (and (eq action 'preview) candidate)
        (when-let* ((target
                     (reference-explorer-source-lookup--thesaurus-candidate-value
                      candidate))
                    (entry
                     (reference-explorer-source-lookup--candidate-preview-entry target))
                    (minibuffer-window (active-minibuffer-window))
                    (position
                     (reference-explorer-source-lookup--vertico-candidate-position)))
          (setq preview
                (reference-explorer-source-lookup--show-temporary-preview-at-position
                 entry position minibuffer-window
                 (reference-explorer-source-lookup--thesaurus-term target))))))))

(defun reference-explorer-source-lookup--consult-thesaurus
            ...
            (catch tag
              (list
               ...
               (consult--read
                ...
                :annotate #'reference-explorer-source-lookup--thesaurus-annotation
                :state (reference-explorer-source-lookup--thesaurus-preview-state)
                :preview-key
                `(:debounce ,reference-explorer-source-lookup-preview-debounce any))))))
      (pcase result
        (`(return ,selected)
         (when selected
           (reference-explorer-source-lookup-thesaurus-replace selected)))
        (`(interact ,preview ,window)
         (reference-explorer-source-lookup--activate-preview-interaction
          preview window))))))

(defun reference-explorer-source-lookup--thesaurus-show-targets
    (query targets source-window source-marker source-bounds)
  "Show QUERY's thesaurus TARGETS using quick UI or Consult."
  (if (not (display-graphic-p))
      (reference-explorer-source-lookup--consult-thesaurus targets source-window)
    (reference-explorer-source-lookup--quick-open-session
     (reference-explorer-source-lookup--make-quick-session
      :query query
      ...
      :source-marker source-marker
      :source-bounds source-bounds
      :accept-function #'reference-explorer-source-lookup-thesaurus-replace
      :consult-function
      (lambda (entries)
        (reference-explorer-source-lookup--consult-thesaurus entries source-window))
      :help "TAB:置換  H-i:preview操作  M-m:Consult  Embark:その他の操作"))))

(defun reference-explorer-source-lookup--thesaurus-targets
...
(defun reference-explorer-source-lookup--query-bounds-at-point (query)
...
(defun reference-explorer-source-lookup--thesaurus-search
    ...
    (reference-explorer-source-thesaurus-fetch
     ...
     (lambda (results)
       (cond
        ...
        (t
         (let ((targets
                (reference-explorer-source-lookup--thesaurus-targets
...
;;;###autoload
(defun reference-explorer-source-lookup-thesaurus-at-point ()
  ...
  (let* ((region-active (use-region-p))
         ...
         (bounds
          (if region-active
            ...
            (and query
                 (reference-explorer-source-lookup--query-bounds-at-point query)))))
    (unless (and query bounds)
      (user-error "No replaceable thesaurus query at point"))
    (reference-explorer-source-lookup--thesaurus-search
     query (current-buffer) (car bounds) (cdr bounds)
     (selected-window) (copy-marker (point)))))

(defun reference-explorer-source-lookup-thesaurus-search-candidate (candidate)
...
(defun reference-explorer-source-lookup--export-cancel-preview ()
  ...
  (when (timerp reference-explorer-source-lookup--export-preview-timer)
    (cancel-timer reference-explorer-source-lookup--export-preview-timer))
  (setq reference-explorer-source-lookup--export-preview-timer nil)
  (when reference-explorer-source-lookup--export-preview
    (reference-explorer-source-lookup--close-temporary-preview
     reference-explorer-source-lookup--export-preview))
  (setq reference-explorer-source-lookup--export-preview nil
        reference-explorer-source-lookup--export-preview-entry nil))
        ...
        (when-let* ((window
                    ...
                    (position
                     (reference-explorer-source-lookup--export-candidate-position
                      window)))
          (setq reference-explorer-source-lookup--export-preview
                (reference-explorer-source-lookup--show-temporary-preview-at-position
...
(defun reference-explorer-source-lookup--export-schedule-preview ()
  ...
  (let ((entry (reference-explorer-source-lookup--export-entry-at-point)))
    (unless (and (eq entry reference-explorer-source-lookup--export-preview-entry)
                 (or (timerp reference-explorer-source-lookup--export-preview-timer)
                     (reference-explorer-source-lookup--preview-live-p
                      reference-explorer-source-lookup--export-preview)))
      (reference-explorer-source-lookup--export-cancel-preview)
      (when entry
        (setq reference-explorer-source-lookup--export-preview-entry entry
              reference-explorer-source-lookup--export-preview-timer
              (run-with-idle-timer
               reference-explorer-source-lookup-preview-debounce nil
...
(defvar-keymap reference-explorer-source-lookup-consult-map
  :doc "Keymap active while selecting a Lookup entry."
  "M-m" #'reference-explorer-source-lookup-toggle-consult-mode
  "H-s" #'reference-explorer-source-lookup-consult-shorten-query
  "H-e" #'reference-explorer-source-lookup-consult-expand-query
  "H-v" #'reference-explorer-source-lookup-preview-scroll-up
  "H-V" #'reference-explorer-source-lookup-preview-scroll-down
  "H-i" #'reference-explorer-source-lookup-consult-activate-preview
  "H-." #'reference-explorer-source-lookup-consult-open-reference
  "TAB" #'reference-explorer-source-lookup-select-candidate
  "<tab>" #'reference-explorer-source-lookup-select-candidate)

(defun reference-explorer-source-lookup-consult-activate-preview ()
  "Exit Consult and promote its current preview for interaction."
  (interactive)
  (unless reference-explorer-source-lookup--consult-toggle-tag
    (user-error "No Consult Lookup session is active"))
  (let ((preview reference-explorer-source-lookup--active-temporary-preview)
        (origin-window
         (and reference-explorer-source-lookup--consult-origin
              (reference-explorer-context-window
               reference-explorer-source-lookup--consult-origin))))
    (unless (and (reference-explorer-source-lookup--preview-p preview)
                 (reference-explorer-source-lookup--preview-entry preview))
      (user-error "The current candidate has no operable preview"))
    (when (reference-explorer-source-lookup--active-webkit-preview-xwidget)
      (setq reference-explorer-source-lookup--preview-interaction-request preview))
    (throw reference-explorer-source-lookup--consult-toggle-tag
           (list 'interact preview origin-window))))

(defun reference-explorer-source-lookup--consult-run-provider (&optional provider)
  "Open the active Consult query through PROVIDER or configured order."
  (unless reference-explorer-source-lookup--consult-origin
    (user-error "No Consult Lookup session is active"))
...
(defun reference-explorer-source-lookup-consult-open-reference ()
  "Open the active Consult query with the configured provider order."
  (interactive)
  (reference-explorer-source-lookup--consult-run-provider))

(defun reference-explorer-source-lookup-consult-macos-dictionary ()
  "Forward the active Consult query to macOS Dictionary."
  (interactive)
  (reference-explorer-source-lookup--consult-run-provider 'macos-dictionary))

(defun reference-explorer-source-lookup-consult-monokakido ()
  "Forward the active Consult query to Dictionaries by Monokakido."
  (interactive)
  (reference-explorer-source-lookup--consult-run-provider 'monokakido))

(defun reference-explorer-source-lookup-select-candidate ()
...
(defun reference-explorer-source-lookup--consult-change-query (delta)
  "Move DELTA steps through the contextual Consult query options."
  (unless reference-explorer-source-lookup--consult-query-options
    (user-error "No contextual Lookup query options"))
  (let* ((input (minibuffer-contents-no-properties))
         (matched-index
          (seq-position reference-explorer-source-lookup--consult-query-options
                        input #'equal))
         (old-index (or matched-index
                        reference-explorer-source-lookup--consult-query-index
                        0))
         (new-index
          (max 0
               (min (1- (length reference-explorer-source-lookup--consult-query-options))
                    (+ old-index delta)))))
    (if (= old-index new-index)
        (message (if (> delta 0)
                     "これ以上縮小できません"
                   "これ以上拡大できません"))
      (setq reference-explorer-source-lookup--consult-query-index new-index)
      (delete-minibuffer-contents)
      (insert (nth new-index reference-explorer-source-lookup--consult-query-options)))))

(defun reference-explorer-source-lookup-consult-shorten-query ()
  "Use the next shorter contextual query in Consult Lookup."
  (interactive)
  (reference-explorer-source-lookup--consult-change-query 1))

(defun reference-explorer-source-lookup-consult-expand-query ()
  "Use the next longer contextual query in Consult Lookup."
  (interactive)
  (reference-explorer-source-lookup--consult-change-query -1))

(defun reference-explorer-source-lookup-toggle-consult-mode ()
  "Toggle literal and converted search in the active Lookup minibuffer."
  (interactive)
  (unless reference-explorer-source-lookup--consult-toggle-tag
    (user-error "No Consult Lookup session is active"))
  (let ((mode (if (eq reference-explorer-source-lookup--active-consult-mode 'literal)
                  'converted
                'literal))
        (input (minibuffer-contents-no-properties)))
    (setq reference-explorer-source-lookup-consult-mode mode)
    (throw reference-explorer-source-lookup--consult-toggle-tag
           (list 'toggle mode input))))

(defun reference-explorer-source-lookup--completion-overrides (mode)
  "Return completion category overrides appropriate for MODE."
  (if (eq mode 'converted)
      (progn
        (unless reference-explorer-source-lookup-converted-completion-style
          (user-error "Converted search requires a configured completion style"))
        (cons
         `(reference-explorer-source-lookup-entry
           (styles ,reference-explorer-source-lookup-converted-completion-style basic))
...
(defun reference-explorer-source-lookup--consult-read (initial mode)
  ...
  (require 'consult)
  (let* ((reference-explorer-source-lookup--active-consult-mode mode)
         (tag (make-symbol "reference-explorer-source-lookup-toggle"))
         (reference-explorer-source-lookup--consult-toggle-tag tag)
         (completion-category-overrides
          (reference-explorer-source-lookup--completion-overrides mode))
         (result
          (catch tag
            (list
             'return
             (consult--read
              (consult--dynamic-collection
                ...
                :min-input 1
                :debounce reference-explorer-source-lookup-search-debounce)
              :prompt (format "Lookup [%s] (M-m toggles): " mode)
              :initial initial
              :history 'reference-explorer-source-lookup-history
              :category 'reference-explorer-source-lookup-entry
              :require-match t
              :sort nil
              :keymap reference-explorer-source-lookup-consult-map
              :lookup #'consult--lookup-candidate
              :annotate #'reference-explorer-source-lookup--entry-annotation
              :state (reference-explorer-source-lookup--preview-state)
              :preview-key
              `(:debounce ,reference-explorer-source-lookup-preview-debounce any))))))
    result))
...
QUERIES lists longest-to-shortest contextual inputs available with H-e/H-s."
  (let ((reference-explorer-source-lookup--consult-query-options queries)
        (reference-explorer-source-lookup--consult-query-index
...
(defun reference-explorer-source-lookup-consult ()
  ...
  (let ((reference-explorer-source-lookup--consult-origin
         (reference-explorer-context-create
          ...
          :marker (copy-marker (point))
          :window (selected-window))))
    (reference-explorer-source-lookup--consult-loop nil reference-explorer-source-lookup-consult-mode)))
...
(defun reference-explorer-source-lookup--context-major-mode (context)
  "Return the originating major mode recorded by CONTEXT."
  (when-let* ((marker (reference-explorer-context-marker context))
              (buffer (and (markerp marker) (marker-buffer marker))))
    (buffer-local-value 'major-mode buffer)))

(defun reference-explorer-source-lookup--context-query-options (context)
...
(defun reference-explorer-source-lookup--consult-docset-read (initial mode)
    ...
    (catch tag
      (list
       ...
       (consult--read
        (consult--dynamic-collection
            (lambda (input)
              (reference-explorer-source-lookup--docset-candidates input mode))
          :min-input 1
          :debounce reference-explorer-source-lookup-search-debounce)
        :prompt "Docset: "
        :initial initial
        ...
        :annotate (lambda (candidate)
                    (reference-explorer-source-lookup--docset-annotation candidate mode))
        :state (reference-explorer-source-lookup--preview-state)
        :preview-key `(:debounce ,reference-explorer-source-lookup-preview-debounce any))))))

(defun reference-explorer-source-lookup-consult-docset (query mode &optional origin-window)
...
ORIGIN-WINDOW receives focus after direct preview interaction ends."
  (let ((reference-explorer-source-lookup--consult-origin
         (reference-explorer-context-create
          :query query
          :window (or origin-window (selected-window)))))
    (pcase (reference-explorer-source-lookup--consult-docset-read query mode)
      (`(return ,result)
       (when result
         (reference-explorer-source-lookup--display-entry result)))
      (`(interact ,preview ,window)
...
(defun reference-explorer-source-lookup--docset-quick-options (queries mode)
  "Search every member of QUERIES in docsets selected for MODE."
  (mapcar (lambda (query)
            (cons query (reference-explorer-source-docset-search query mode)))
          queries))

(defun reference-explorer-source-lookup-docset-provider-available-p ()
  "Return non-nil when Emacs has built-in SQLite support."
  (sqlite-available-p))

(defun reference-explorer-source-lookup-docset-provider-display (context)
  "Display docset matches for reference CONTEXT."
  (let* ((mode (reference-explorer-source-lookup--context-major-mode context))
    ...
    (let* ((queries (or (reference-explorer-source-lookup--context-query-options context)
                        (list (reference-explorer-context-query context))))
           (options (reference-explorer-source-lookup--docset-quick-options queries mode))
           (query (caar options))
           (source-window (reference-explorer-context-window context))
           (source-marker (reference-explorer-context-marker context)))
      (if (not (display-graphic-p))
          (reference-explorer-source-lookup-consult-docset query mode source-window)
        (reference-explorer-source-lookup--quick-open-session
         (reference-explorer-source-lookup--make-quick-session
          :query query
...
(reference-explorer-register-provider
 'docset
 #'reference-explorer-source-lookup-docset-provider-display
 #'reference-explorer-source-lookup-docset-provider-available-p)
    ...
    (setq-local buffer-face-mode-face
                (append
                 (when (and reference-explorer-source-lookup-content-font-family
                            (find-font
                             (font-spec
                              :family reference-explorer-source-lookup-content-font-family)))
                   (list :family reference-explorer-source-lookup-content-font-family))
                 '(:height 1.15)))
    (buffer-face-mode 1)))
...
(with-eval-after-load 'savehist
  (add-to-list 'savehist-additional-variables
               'reference-explorer-source-lookup-consult-mode)
  (add-to-list 'savehist-additional-variables
               'reference-explorer-source-lookup-history))

(with-eval-after-load 'embark
  (set-keymap-parent reference-explorer-source-lookup-embark-map embark-general-map)
  (set-keymap-parent reference-explorer-source-lookup-thesaurus-embark-map
                     embark-general-map)
  (set-keymap-parent reference-explorer-source-lookup-docset-embark-map
                     embark-general-map)
  ...
  (define-key reference-explorer-source-lookup-thesaurus-embark-map (kbd "RET")
              #'reference-explorer-source-lookup-thesaurus-replace)
  (define-key reference-explorer-source-lookup-thesaurus-embark-map (kbd "r")
              #'reference-explorer-source-lookup-thesaurus-replace)
  (define-key reference-explorer-source-lookup-thesaurus-embark-map (kbd "l")
              #'reference-explorer-source-lookup-thesaurus-lookup)
  (define-key reference-explorer-source-lookup-thesaurus-embark-map (kbd "w")
              #'reference-explorer-source-lookup-thesaurus-copy)
  (define-key reference-explorer-source-lookup-thesaurus-embark-map (kbd "s")
              #'reference-explorer-source-lookup-thesaurus-search-candidate)
  (add-to-list 'embark-keymap-alist
               '(reference-explorer-source-thesaurus-candidate
                 . reference-explorer-source-lookup-thesaurus-embark-map))
  (setf (alist-get 'reference-explorer-source-thesaurus-candidate
                   embark-default-action-overrides)
        #'reference-explorer-source-lookup-thesaurus-replace)
  (define-key reference-explorer-source-lookup-docset-embark-map (kbd "RET")
              #'reference-explorer-source-lookup-display-docset-candidate)
  (define-key reference-explorer-source-lookup-docset-embark-map (kbd "w")
              #'reference-explorer-source-lookup-copy-docset-url)
  (define-key reference-explorer-source-lookup-docset-embark-map (kbd "b")
              #'reference-explorer-source-lookup-browse-docset-candidate)
  (add-to-list 'embark-keymap-alist
               '(reference-explorer-source-docset-result
                 . reference-explorer-source-lookup-docset-embark-map))
