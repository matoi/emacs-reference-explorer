...
emacs_module_init(struct emacs_runtime *runtime)
{
  ...
  emacs_value function = env->make_function(
    ...
    NULL);
  emacs_value symbol =
    env->intern(env, "reference-explorer-macos-show-definition");
  ...
  emacs_value fontSymbol =
    env->intern(env, "reference-explorer-macos-show-definition-with-font");
  ...
  emacs_value automaticSymbol =
    env->intern(env, "reference-explorer-macos-show-definition-at-offset");
  ...
  emacs_value termSymbol =
    env->intern(env, "reference-explorer-macos-term-at-offset");
  ...
  emacs_value selectionSymbol =
    env->intern(env, "reference-explorer-macos-selection-at-offset");
  ...
  emacs_value hideSymbol =
    env->intern(env, "reference-explorer-macos-hide-definition");
  emacs_value hideAliasArgs[] = { hideSymbol, hideFunction };
  env->funcall(env, defalias, 2, hideAliasArgs);

  emacs_value provide = env->intern(env, "provide");
  emacs_value feature =
    env->intern(env, "reference-explorer-macos-module");
